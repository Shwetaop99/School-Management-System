...
class AdminTimetableController extends Controller
{
    ...
    */
    ...
    | URL:
    |
    | /admin/timetable/{class_id}/{section_id}/{academic_year}/pdf
    |
    | Example:
    |
    | /admin/timetable/4/11/2026-27/pdf
    |
    */
    ...
    public function downloadPdf(
        ...
        */
        ...
        $academicYear = trim($academic_year);
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | This also confirms that section belongs to selected class.
        |
        */
